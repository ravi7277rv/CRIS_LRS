...
const RailFractureChart = ({ newMapObj, layer, cQuery, bQuery, lastThreeyears }) => {
  let id = newMapObj.id;
            ...
            (
              <>
                ...
                <div className="chartContainerZW" style={{
                  ...
                  <BarChart
                    id={id}
                    title="No. of Rail Fractures - Year Wise"
                ...
                <div className="chartContainerZW" style={{
                  ...
                  <PieChart
                    id={id}
                    title="No. of Fractures - USFD Classification Wise"
...
export default RailFractureChart