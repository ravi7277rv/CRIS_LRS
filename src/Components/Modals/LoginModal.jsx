...
const LoginModal = ({ userName, setUserName, userPassword, setUserPassword, handleUserLoggingIn, setLoginModal }) => {
    ...
    return (
        <div className='loginModal'>
            <div className="loginModalHeader">
                <span className='tagSpan'>User LogIn</span> <span className='closeSpan' onClick={() => setLoginModal(false)}>X</span>
            </div>
            <div className="crisTagImage">
                <img className="imgTagName" src="/cris_lrs/images/crisTag.png" alt="CrisTag.png" />
            </div>
            <div className="loginModalInput">
                <div className="Input">
                    <svg onClick={''} className='loginSVG' width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="Input">

                    {
                        isVisible === true ? (
                            <>
                                <svg onClick={handleHidePassword} width="20px" className='loginSVG' height="20px" style={{ cursor: "pointer" }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <>
                                <svg onClick={handleShowPassword} width="20px" className='loginSVG' height="20px" style={{ cursor: "pointer" }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <div className="buttonDiv">
                <button className='btnLogin' onClick={handleUserLoggingIn}>LogIn</button>
            </div>
        </div>
    )
}
